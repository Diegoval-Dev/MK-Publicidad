...
const Pending = () => {
  ...
  // Función para obtener las cotizaciones pendientes
  ...
  return (
    <div className='py-8'>
      ...
      <div className='flex flex-column justify-self-center'>
        <button className="w-full bg-color-button text-white font-bold py-2 px-4 rounded-lg hover:bg-color-symbols transition-colors mx-5">
          Aceptar
        </button>
        <button className="w-full bg-color-button text-white font-bold py-2 px-4 rounded-lg hover:bg-color-symbols transition-colors">
          Rechazar
        </button>
      </div>
    </div>
